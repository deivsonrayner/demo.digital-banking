module.exports = function (request, dateFormat) {
    ...
    function dropBills() {
        var options = {
            method: 'GET',
            uri: `http://${process.env.DROP_BILLS_ENDPOINT}`,
            json: true
        };
    ...
    function dropTransactions() {
        var options = {
            method: 'GET',
            uri: `http://${process.env.DROP_TRANSACTIONS_ENDPOINT}`,
            json: true
        };
        request.get(options, function (err, response, body) {
            return;
    ...
    function dropAccounts() {
        var options = {
            method: 'GET',
            uri: `http://${process.env.DROP_ACCOUNTS_ENDPOINT}`,
            json: true
        };
        request.get(options, function (err, response, body) {
            return;
    ...
    function populate() {
        ...
        return new Promise(function (resolve, reject) {
            var options = {
                method: 'GET',
                uri: `http://${process.env.GET_USERS_ENDPOINT}`,
                json: true
            };
            request.get(options, function (err, response, body) {
                if (err) {
